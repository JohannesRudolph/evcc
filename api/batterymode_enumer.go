...
const _BatteryModeName = "unknownnormalholdchargenochargedischarge"

var _BatteryModeIndex = [...]uint8{0, 7, 13, 17, 23, 31, 40}

const _BatteryModeLowerName = "unknownnormalholdchargenochargedischarge"
...
var _BatteryModeValues = []BatteryMode{BatteryUnknown, BatteryNormal, BatteryHold, BatteryCharge, BatteryNoCharge, BatteryDischarge}
...
var _BatteryModeNameToValueMap = map[string]BatteryMode{
	...
	_BatteryModeName[31:40]:      BatteryDischarge,
	_BatteryModeLowerName[31:40]: BatteryDischarge,
}
